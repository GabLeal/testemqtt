...
class MqttConnControlClass extends ChangeNotifier{
  ...
  bool isConnected(){
    if(client.connectionStatus.state!=MqttConnectionState.connected) {
      print('log - isConnected - Cliente esta desconectado');
      _constructListener(0, 'isConnected>Cliente esta desconectado');
      return false;
    }
    print('log - isConnected - Cliente esta conectado');
    _constructListener(0, 'isConnected>Cliente esta conectado');
    return true;
  }
